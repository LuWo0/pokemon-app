                ...
                <nav>
                    <ul>
                        <li>
                            ...
                            <img src="/images/mimikyu.png" alt="mimikyu picture" />
                        ...
                        <li>
                            ...
                            <img src="/images/recently.jpeg" alt="recently in usa" />
                            <div className="bg-lime-700 text-xs py-1">
                                <p>Episode 1179</p>
                        ...
                        <li>
                            ...
                            <img src="/images/spirittomb.jpeg" alt="spirittomb" />
                            <div className="bg-lime-700 text-xs py-1">
                                <p>Episode 1180</p>
                        ...
                        <li>
                            ...
                            <nav className="bg-lime-700">
                               <ul className="flex justify-center gap-1">
                                <li><img src="/images/Facebook.png" alt="Facebook" className=" w-8 h-8" /></li>
                                <li><img src="/images/Twitter.png" alt="Twitter" className=" w-8 h-8" /></li>
                                <li><img src="/images/Youtube.png" alt="Youtube" className=" w-8 h-8" /></li>
                                <li><img src="/images/Instagram.png" alt="Instagram" className=" w-8 h-8" /></li>
                               </ul>
                            </nav>
                        </li>
                        <li>
                            ...
                            <div className="bg-lime-700 flex flex-col justify-start items-center gap-1 py-2">
                                <img className=" w-20 h-8" src="/images/pm.png" alt="pm" />
                                <img className=" w-20 h-8" src="/images/lpoke.png" alt="lpoke" />
                            </div>
                        </li>
                    </ul>
                </nav>   
